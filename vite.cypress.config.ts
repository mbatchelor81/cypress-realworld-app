import { defineConfig, mergeConfig, loadEnv, type ConfigEnv, type UserConfig } from "vite";
import viteConfig from "./vite.config";

export default defineConfig(({ mode }: ConfigEnv = { mode: "development", command: "serve" }) =>
  mergeConfig(
