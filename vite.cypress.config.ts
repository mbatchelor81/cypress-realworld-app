import { defineConfig, mergeConfig, loadEnv, type ConfigEnv } from "vite";
import viteConfig from "./vite.config";

const defaultEnv: ConfigEnv = { mode: "development", command: "serve" };

export default defineConfig(({ mode } = defaultEnv) =>
  mergeConfig(
