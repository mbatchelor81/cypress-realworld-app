...
const TransactionTitle: React.FC<{
  ...
  const requestAction = isAcceptedRequestTransaction(transaction) ? " charged " : " requested ";
  const transactionAction = isRequestTransaction(transaction) ? requestAction : " paid ";
